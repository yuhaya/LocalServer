...
func init() {
	...
	beego.Router("/family/members/parent/post", &controllers.FamilyController{}, "get:EditUserShow;post:EditUser")
	beego.Router("/family/members/stu", &controllers.FamilyController{}, "get:ShowStu")
	beego.Router("/family/members/stu/post", &controllers.FamilyController{}, "get:EditStuShow;post:EditStu")
	beego.Router("/family/members/main", &controllers.FamilyController{}, "post:SetMainUser")
	grade()
	class()
}
