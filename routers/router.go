...
func init() {
	...
	beego.Router("/family/members/parent", &controllers.FamilyController{}, "get:ShowUser;post:EditUser")
	beego.Router("/family/members/stu", &controllers.FamilyController{}, "get:ShowStu;post:EditStu")
